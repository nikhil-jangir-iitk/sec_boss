...
-- `auth.uid()` to user_id directly. That is the shape 20260923150000 rewrote
...
-- 20260923150000 had been written and reviewed, and keeping them apart keeps
-- that one's 80 statements as they were reviewed. Both now run after the
-- terminal_sessions migrations.
--
-- Same method as 20260923150000: ALTER POLICY restating only USING and
